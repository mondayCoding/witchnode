...
var validationModule_1 = require("../utils/validationModule");
var validationModule_2 = require("../utils/validationModule");
var Dashboard = (function (_super) {
    ...
    Dashboard.prototype.componentDidMount = function () {
        ...
        var nom = validationModule_1.default;
        var testState = { name: 'Alince', age: 19, email: "email@email.email" };
        var testValidation = new validationModule_2.default([
            {
                field: "email",
                method: "isEmail",
                message: "......",
                rule: function (z) { return validationModule_1.default.isEmail(z); }
            },
            {
                field: "name",
                method: "isName",
                message: "tootally sucks",
                rule: function (z) { return !validationModule_1.default.isEmpty(z); }
            },
            {
                field: "nom",
                method: "isEmail",
                message: "u done bad, git gud",
                rule: function (x) { return validationModule_1.default.isAlpha(x); }
            }
        ]);
        console.log(nom.validate({
            name: "name",
            nom: "SASDASD",
            email: "fgdfgdg.asdasd@email.com"
        }));
    };
